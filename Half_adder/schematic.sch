...
load port c output -pg 1 -lvl 2 -x 190 -y 40
load port s output -pg 1 -lvl 2 -x 190 -y 110
load inst c0_i RTL_AND work -attr @cell(#000000) RTL_AND -pg 1 -lvl 1 -x 90 -y 40
load inst s0_i RTL_XOR work -attr @cell(#000000) RTL_XOR -pg 1 -lvl 1 -x 90 -y 110
load net a -port a -pin c0_i I0 -pin s0_i I0
netloc a 1 0 1 20 30n
load net b -port b -pin c0_i I1 -pin s0_i I1
netloc b 1 0 1 40 50n
load net c -port c -pin c0_i O
netloc c 1 1 1 NJ 40
load net s -port s -pin s0_i O
netloc s 1 1 1 NJ 110
